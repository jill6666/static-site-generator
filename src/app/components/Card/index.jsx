...
import { OpenInNewWindowIcon, Pencil2Icon, TrashIcon, CopyIcon } from '@radix-ui/react-icons';
...
const Card = ({
  ...
  return (
    <CardMarkup className="border rounded-none max-w-[250px] bg-white flex flex-col">
      <Image width={'100%'} height={'120px'} src={imgUrl} alt="Image" style={{ objectFit: 'cover' }} />
